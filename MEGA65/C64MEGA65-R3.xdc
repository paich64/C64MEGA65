...
create_generated_clock -name tmds_720p_clk [get_pins */clk_gen/i_clk_hdmi_720p/CLKOUT0]
create_generated_clock -name hdmi_720p_clk [get_pins */clk_gen/i_clk_hdmi_720p/CLKOUT1]
create_generated_clock -name tmds_576p_clk [get_pins */clk_gen/i_clk_hdmi_576p/CLKOUT0]
...
set_multicycle_path -from [get_cells -include_replicated {{*/QNICE_SOC/eae_inst/op0_reg[*]} \
                       ...
                       -to [get_cells -include_replicated {*/QNICE_SOC/eae_inst/res_reg[*]}] -setup 3
set_multicycle_path -from [get_cells -include_replicated {{*/QNICE_SOC/eae_inst/op0_reg[*]} \
                                                          {*/QNICE_SOC/eae_inst/op1_reg[*]}}] \
